...
const pendingPlayListing = document.querySelector(".pending-playlist");
const songTitle = document.querySelector(".song-title");
const songArtist = document.querySelector(".song-artist");
const currentSongTitle = document.getElementById("music-title");
...
function loadSong(song) {
  currentSongTitle.innerText = songs[songIndex];
...
function playSong() {
  ...
  playBtn.querySelector("i.fas").classList.remove("ti-control-play");
  playBtn.querySelector("i.fas").classList.add("ti-control-pause");
...
function pauseSong() {
  ...
  playBtn.querySelector("i.fas").classList.add("ti-control-play");
  playBtn.querySelector("i.fas").classList.remove("ti-control-pause");
